...
/////////////////////////////////////START////////////////////////////////////////
##################################################################################
$messaggiostart = "Benvenuto <a href='tg://user?id=$from_id'>$from_first_name</a>!\nQuesto è il bot ufficiale di @TUOCANALE.\n\n<b>❓ A cosa servo ❓\n</b>Servo a bannare automaticamente i truffatori da un gruppo, per capire come, clicca ".'"<b>Guida</b>"!';
...
if ($limiter) {
	...
	switch ($data) {
		...
		case 'faq':
			...
			break;
		case 'moreinfo':
			editMessageText("<b>Informazioni</b>\n\nQuesto bot è nato il giorno 1 novembre 2019 ed è stato programmato completamente in <b>PHP 7.2</b> da <a href='tg://user?id=2992'>TUONOME</a> e <a href='tg://user?id=541555995'>Rudy</a>.\n\nVersione attuale: <b>1.2</b>\n\n<b>Ringraziamo</b> tutti gli utenti che ogni giorno ci <b>segnalano</b> nuovi truffatori.", $message_chat_id, $message_message_id, null, 'HTML', null, $faq);
			break;
		case 'listacomandi':
...
\n<b>/supporto »  </b><i>Da eseguire in un gruppo, invia una richiesta di supporto agli amminitratori si SBL.</i>", $message_chat_id, $message_message_id, null, 'HTML', null, $listacomandi);
	...
	sendMessage("834560041", "Qualcuno sta spammando\nUtente: $from_first_name\nID: $from_id\nCHAT_ID: $chat_id", 'HTML');
	die;
}
